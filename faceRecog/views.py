...
def create_dataset(request):
    ...
    faceDetect = cv2.CascadeClassifier('C:\\Users\\Sakshi gupta\\Desktop\\Smart-Search-Using-Face-Recognition-master\\Facial\\Facial\\ml\\haarcascade_frontalface_default.xml')
    ...
    while(True):
        ...
        for(x,y,w,h) in faces:
            ...
            cv2.imwrite('C:\\Users\\Sakshi gupta\\Desktop\\Smart-Search-Using-Face-Recognition-master\\Facial\\Facial\\ml\\dataset\\User.'+str(id)+'.'+str(sampleNum)+'.jpg', gray[y:y+h,x:x+w])
...
def trainer(request):
    ...
    #Path of the samples
    path = 'C:\\Users\\Sakshi gupta\\Desktop\\Smart-Search-Using-Face-Recognition-master\\Facial\\Facial\\ml\\dataset'
    ...
    recognizer.save('C:\\Users\\Sakshi gupta\\Desktop\\Smart-Search-Using-Face-Recognition-master\\Facial\\Facial\\ml\\recognizer\\trainingData.yml')
    cv2.destroyAllWindows()
...
def detect(request):
    ...
    rec.read('C:\\Users\\Sakshi gupta\\Desktop\\Smart-Search-Using-Face-Recognition-master\\Facial\\Facial\\ml\\recognizer\\trainingData.yml')
    getId = 0
